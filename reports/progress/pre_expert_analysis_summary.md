...
- Expert card-sorting validation is complete (14 consultants): the macro structure (k=3) matches the consensus strongly (ARI 0.84, both IDF and binary), while the top-level k=4 partition agrees only modestly (IDF 0.52, binary 0.59); admission score feasibility and candidate generation remain future work.
