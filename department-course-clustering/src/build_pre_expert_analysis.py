...
def build_pair_tables(
    ...
    return pairs.sort_values("course_similarity_weighted", ascending=False)
...
def main() -> None:
    ...
    metrics = pd.concat([kmeans_metrics(weighted, "weighted", cluster_counts), kmeans_metrics(binary, "binary", cluster_counts)])
